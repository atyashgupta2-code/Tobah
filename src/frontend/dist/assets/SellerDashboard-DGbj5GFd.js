import { a as createLucideIcon, b as useNavigate, r as reactExports, O as OrderStatus, j as jsxRuntimeExports, c as cn, S as Skeleton, h as Package, F as FulfillmentBy } from "./index-D052jQ_k.js";
...
import { a as useSellerProducts, b as useListOrdersBySeller, c as useSellerDeleteProduct, d as useAcceptOrder, e as useRejectOrder } from "./useSeller-D_J5zCwb.js";
import { L as LayoutDashboard } from "./layout-dashboard-Cor2TsiR.js";
...
import { U as User, P as Phone } from "./user-f2obrnNr.js";
import { M as MapPin } from "./map-pin-Cd9c7V0k.js";
...
function useProduct(productId, productsMap) {
  const { actor, isFetching } = useActor(createActor);
...
function OrderItemRow({
  ...
  const displayPrice = price ? Number(price) / 100 : product ? Number(product.price) / 100 : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-14 h-14 rounded-lg overflow-hidden bg-muted border border-border", children: isLoading && !product ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full" }) : (product == null ? void 0 : product.imageUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          isLoading && !product ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-32 rounded mb-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: (product == null ? void 0 : product.name) ?? `Product …${productId.slice(-6)}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5 flex-wrap", children: [
            selectedSize && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded font-medium", children: [
              "Size: ",
              selectedSize
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground font-semibold", children: [
              "Qty: ",
              Number(quantity)
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-right", children: [
          displayPrice !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-bold text-sm text-primary", children: [
            "₹",
            (displayPrice * Number(quantity)).toLocaleString("en-IN")
          ] }) : null,
          displayPrice !== null && Number(quantity) > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground", children: [
            "₹",
...
function parseAddress(raw) {
  ...
  const parts = raw.replace(pincode, "").split(/[,\-|]+/).map((s) => s.trim()).filter(Boolean);
...
function SellerOrderCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-3 border-b border-border/50 flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs font-bold text-primary bg-primary/10 px-2 py-0.5 rounded-md", children: [
                "#",
                shortId
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: new Date(Number(order.createdAt) / 1e6).toLocaleString(
              "en-IN",
              {
                day: "numeric",
                month: "short",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/20 rounded-xl p-3 space-y-2 border border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground mb-1", children: "Customer Details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 13, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: order.customerName || "Customer" })
            ] }),
            order.customerPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 13, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground leading-relaxed break-words", children: order.shippingAddress }),
                (city || pincode) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-1 flex-wrap", children: [
                  city && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center text-[11px] font-bold bg-primary/10 text-primary px-2 py-0.5 rounded-full", children: [
                    "📍 ",
                    city
                  ] }),
                  pincode && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center text-[11px] font-semibold bg-muted text-muted-foreground px-2 py-0.5 rounded-full", children: [
                    "PIN: ",
                    pincode
                  ] })
                ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground mb-2", children: "Ordered Items" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: order.items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              OrderItemRow,
              {
            ...
            order.discountAmount && Number(order.discountAmount) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2 px-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                "Coupon discount",
                order.couponCode ? ` (${order.couponCode})` : ""
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-green-400", children: [
                "−₹",
                (Number(order.discountAmount) / 100).toLocaleString("en-IN")
              ] })
            ] }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-1 px-1 pt-2 border-t border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-muted-foreground uppercase tracking-wide", children: "Total" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-black text-base text-foreground", children: [
                "₹",
                (Number(order.total) / 100).toLocaleString("en-IN")
              ] })
            ] })
          ] }),
          order.fulfillmentChoice && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 13, className: "text-muted-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              "Delivery by:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: order.fulfillmentChoice === FulfillmentBy.SellerFulfilled ? "You (Seller)" : "TBah Admin" })
            ] })
          ] }),
          canAct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-1", children: [
...
function SellerOrdersSection({
  ...
  const productsMap = sellerProducts.reduce(
    (acc, p) => {
      acc[p.id] = p;
      return acc;
    },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "seller.orders.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full rounded-2xl" }, i)) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "seller.orders.list", className: "space-y-4", children: filtered.map((order, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SellerOrderCard,
      {
        order,
        index: idx + 1,
