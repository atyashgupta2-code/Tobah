import { r as reactExports, j as jsxRuntimeExports, S as Skeleton, c as cn, L as Link } from "./index-BDCmUi92.js";
import { u as useActor, a as useQuery, c as createActor } from "./backend-DZh8k5AL.js";
import { P as ProductCard, S as Shirt } from "./ProductCard-Dgau0kPM.js";
import { u as useProducts } from "./useProducts-Bh5lsULI.js";
import { B as Banknote, A as AnimatePresence } from "./USPBadge-Q4xQDQx1.js";
...
import "./zap-Dd4_jfuv.js";
import "./useMutation-CCDQEC_w.js";
import "./clock-C2jYw_x8.js";
...
function USPImageCard({ imageUrl, title, accentColor }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: isDeliveredToday ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
...
function InlineCategoryProducts({
  ...
  const filtered = products.filter((p) => category.genderValues.includes(p.gender ?? "")).sort((a, b) => {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: filtered.map((p, i) => (
