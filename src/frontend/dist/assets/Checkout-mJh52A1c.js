import { u as useCart, b as useNavigate, g as useCustomer, r as reactExports, D as DeliveryOption, P as PaymentMethod, j as jsxRuntimeExports, L as Link, h as Package, X } from "./index-D052jQ_k.js";
import { B as Button } from "./button-DGA_N2XK.js";
import { L as Label, I as Input } from "./label-BW0IYpxi.js";
import { b as useCreateOrder, c as useGetCoupon, u as useProducts, a as useProduct } from "./useProducts-DyZ_1eTC.js";
...
function validate(values) {
  ...
  if (!values.city.trim()) {
    ...
    errors.city = "Sorry, we currently only deliver to Jammu. Orders from other cities cannot be placed.";
  }
...
function Checkout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-sm mx-auto px-4 py-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    className: `mt-1 bg-background border-border focus:border-primary ${errors.city && touched.city ? "border-destructive focus:border-destructive" : ""}`
                  }
                ),
                errors.city && touched.city && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
                    "data-ocid": "checkout.city_field_error",
                    className: "flex items-start gap-1.5 text-destructive text-xs mt-1.5 leading-snug",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 12, className: "mt-0.5 shrink-0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: errors.city })
                    ]
                  }
                )
              ] }),
      ...
      values.city.trim() && !isCityJammu(values.city) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sorry, we currently only deliver to Jammu. Orders from other cities cannot be placed." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "lg",
          disabled: createOrder.isPending || values.city.trim().length > 0 && !isCityJammu(values.city),
