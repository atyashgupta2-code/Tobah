...
function from_candid_tuple_n49(_uploadFile, _downloadFile, value) {
  return [
    value[0],
...
function to_candid_OrderStatus_n52(_uploadFile, _downloadFile, value) {
