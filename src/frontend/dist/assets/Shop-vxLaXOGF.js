import { r as reactExports, j as jsxRuntimeExports, c as cn, S as Skeleton } from "./index-BDCmUi92.js";
import { S as Shirt, F as FeaturedProductCard, P as ProductCard } from "./ProductCard-Dgau0kPM.js";
import { u as useProducts } from "./useProducts-Bh5lsULI.js";
import { A as AnimatePresence } from "./USPBadge-Q4xQDQx1.js";
import { a as ChevronUp, C as ChevronDown } from "./chevron-up-BbejM-o3.js";
...
function InlineProducts({
  ...
  const filtered = reactExports.useMemo(() => {
    return products.filter(
      (p) => matchesCategory(p, cat.genderValues) && matchesPrice(p, priceFilter)
    );
