import { a as createLucideIcon, e as useParams, r as reactExports, g as useCustomer, O as OrderStatus, j as jsxRuntimeExports, S as Skeleton, L as Link, P as PaymentMethod, X, D as DeliveryOption, h as Package, d as ShoppingBag } from "./index-BDCmUi92.js";
import { B as Button } from "./button-CZHlOgul.js";
import { d as useOrder, e as useCancelOrder, i as isOrderCancelled, a as useProduct } from "./useProducts-Bh5lsULI.js";
import { C as CircleCheck } from "./circle-check-CH6FQYTB.js";
import { C as Clock } from "./clock-C2jYw_x8.js";
...
function StatusBadge({
  ...
  if (status === "Placed" || status === OrderStatus.Confirmed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wide bg-emerald-500/15 border border-emerald-500/30 text-emerald-400", children: [
      ...
      status === "Placed" ? "Placed ✓" : "Confirmed"
    ] });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-muted shrink-0 border border-border flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 18, className: "text-muted-foreground" }) }),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "You can cancel your order at any time before it's shipped or delivered." })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
              ...
              Link,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 16, className: "mr-2" }),
